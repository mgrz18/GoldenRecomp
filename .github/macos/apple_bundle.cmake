...
set_target_properties(GoldenRecomp PROPERTIES
        MACOSX_BUNDLE TRUE
        MACOSX_BUNDLE_BUNDLE_NAME "GoldenRecomp"
        MACOSX_BUNDLE_GUI_IDENTIFIER "com.github.goldenrecomp"
...
target_sources(GoldenRecomp PRIVATE ${ICNS_FILE})

# Ensure GoldenRecomp depends on create_icns
add_dependencies(GoldenRecomp create_icns)

# Configure Info.plist
configure_file(${CMAKE_SOURCE_DIR}/.github/macos/Info.plist.in ${CMAKE_BINARY_DIR}/Info.plist @ONLY)

# Install the app bundle
install(TARGETS GoldenRecomp BUNDLE DESTINATION .)
...
add_custom_command(TARGET GoldenRecomp POST_BUILD
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_BINARY_DIR}/temp_assets $<TARGET_BUNDLE_DIR:GoldenRecomp>/Contents/Resources/assets
    COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_BINARY_DIR}/temp_assets

    # Copy controller database
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/gamecontrollerdb.txt $<TARGET_BUNDLE_DIR:GoldenRecomp>/Contents/Resources/

    # Set RPATH
    COMMAND install_name_tool -add_rpath "@executable_path/../Frameworks/" $<TARGET_BUNDLE_DIR:GoldenRecomp>/Contents/MacOS/GoldenRecomp

    # Sign the bundle
    COMMAND codesign --verbose=4 --options=runtime --no-strict --sign - --entitlements ${ENTITLEMENTS_FILE} --deep --force $<TARGET_BUNDLE_DIR:GoldenRecomp>
